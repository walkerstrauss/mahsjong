...
//  (unfortunately) broken. The resampling algorithm in SDL_AudioStream is 
//  perfect (and indeed our code is a slight optimization of this algorithm).
//  However, the page buffering is buggy and can fail, causing audio to cut out.
//
//  Both this resampler and the original SDL_AudioStream are an implementation
//  of a bandlimited interpolation resampler as described here:
//
