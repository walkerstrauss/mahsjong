...
#pragma mark Glyph Debugging
     ...
     */
    Mesh<SpriteVertex> getGlyphBoxes() const;
     ...
     * @return a (line) mesh of the quad outlines for the text glyphs
     */
    Mesh<SpriteVertex> getGlyphBoxes(Rect rect) const;
     ...
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh) const;
     ...
     * @return the number of quads generated
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh, Rect rect) const;
