...
public:
    ...
    enum class Hinting : int {
        ...
        /**
         * This is a new hinting to leverage Freetypes subpixel support
         */
        SUBPIXEL = TTF_HINTING_LIGHT_SUBPIXEL,
    };
...
protected:
    ...
    public:
         ...
         */
        bool getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh, const Rect rect) const;
         ...
         * @param mesh      The mesh to store the vertices
         */
        void getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh) const;
...
#pragma mark Glyph Debugging
     ...
     */
    Mesh<SpriteVertex> getGlyphBoxes(const std::string text, const Vec2 origin);
     ...
     * @return a (line) mesh of the quad outlines for the text glyphs
     */
    Mesh<SpriteVertex> getGlyphBoxes(const char* substr, const char* end, const Vec2 origin);
     ...
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh, const std::string text, const Vec2 origin);
     ...
     * @return the number of quads generated
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh, const char* substr, const char* end, const Vec2 origin);
     ...
     * @return the number of quads generated
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh, const std::string text,
                         const Vec2 origin, const Rect rect, float track=0);
     ...
     * @return the number of quads generated
     */
    size_t getGlyphBoxes(Mesh<SpriteVertex>& mesh, const char* substr, const char* end,
                         const Vec2 origin, const Rect rect, float track=0);
...
#pragma mark Internals
     ...
     * @param mesh      The mesh to store the vertices
     */
    bool getOutline(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh, const Rect rect);
