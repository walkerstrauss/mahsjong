...
//
//  This module is a CUGL wrapper about b2_prismatic_joint, implemented to make
...
//
#ifndef __CU_PRISMATIC_JOINT_H__
#define __CU_PRISMATIC_JOINT_H__
 ...
 *
 * This joine requires defining a line of motion using an axis and an anchor
...
public:
     ...
     *
     * @return a newly allocated prismatic joint with default values.
     */
    static std::shared_ptr<PrismaticJoint> alloc() {
        std::shared_ptr<PrismaticJoint> result = std::make_shared<PrismaticJoint>();
     ...
     * @param obsB  The second obstacle to join
     *
     * @return a newly allocated prismatic joint with the given obstacles.
     */
    static std::shared_ptr<PrismaticJoint> allocWithObstacles(const std::shared_ptr<Obstacle>& obsA,
                                                              const std::shared_ptr<Obstacle>& obsB) {
        std::shared_ptr<PrismaticJoint> result = std::make_shared<PrismaticJoint>();
     ...
     * @param localB    The local anchor of the second obstacle
     *
     * @return a newly allocated prismatic joint with the given obstacles and anchors
     */
    static std::shared_ptr<PrismaticJoint> allocWithObstacles(const std::shared_ptr<Obstacle>& obsA,
                                                              const std::shared_ptr<Obstacle>& obsB,
                                                              const Vec2 localA, const Vec2 localB) {
...
#pragma mark Joint Attributes
     ...
     */
    float getMaxMotorForce() const { return _maxMotorForce; }
...
#endif /* __CU_PRISMATIC_JOINT_H__ */
