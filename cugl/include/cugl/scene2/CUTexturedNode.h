...
public:
     ...
     *
     * This will make the texture be {@link graphics::Texture#getBlank}, which
     * is suitable for drawing solid shapes. However, this is an abstract class,
     * so it will not apply any geometry to the texture. You will need to use
     * one of the appropriate subclasses.
     *
     ...
     *
     * If the texture is null, this node will use {@link graphics::Texture#getBlank}
     ...
     *
     * All attributes are optional. If the texture is missing, this node will
     * use {@link graphics::Texture#getBlank} instead, which is suitable for
...
#pragma mark Texture Attributes
     ...
     */
    const std::shared_ptr<graphics::Gradient> getGradient() const { return _gradient; }
...
#pragma mark Drawing Attributes
    ...
    void setBlendFunc(GLenum srcFactor, GLenum dstFactor) {
        _srcFactor = srcFactor; _dstFactor = dstFactor;
    }
