...
public:
     ...
     *
     * The default render order is {@link Order#PRE_ORDER}. When this is set, this
...
protected:
    ...
    public:
        ...
        std::shared_ptr<graphics::Scissor> scissor;
    ...
    std::shared_ptr<graphics::Scissor> _viewport;
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<OrderedNode> allocWithData(const AssetManager* manager,
...
#pragma mark Attributes
     ...
     * @param tint      The tint to blend with the node color.
     */
    void render(const std::shared_ptr<graphics::SpriteBatch>& batch,
