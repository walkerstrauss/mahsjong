...
#pragma mark Constructors
     ...
     */
    ProgressBar() : _progress(1.0f) { _classname = "ProgressBar"; }
     ...
     *
     * The progress bar will be placed at the origin of the parent and by
     ...
     * @return true if the progress bar is initialized properly, false otherwise.
     */
    bool init(const std::shared_ptr<graphics::Texture>& background) {
     ...
     * @return true if the progress bar is initialized properly, false otherwise.
     */
    bool init(const std::shared_ptr<graphics::Texture>& background, const Size size) {
     ...
     */
    bool init(const std::shared_ptr<graphics::Texture>& background,
              const std::shared_ptr<graphics::Texture>& foreground) {
     ...
     * @return true if the progress bar is initialized properly, false otherwise.
     */
    bool initWithCaps(const std::shared_ptr<graphics::Texture>& background,
                      const std::shared_ptr<graphics::Texture>& foreground,
                      const std::shared_ptr<graphics::Texture>& beginCap,
                      const std::shared_ptr<graphics::Texture>& finalCap);
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<ProgressBar> alloc(const std::shared_ptr<graphics::Texture>& background) {
        std::shared_ptr<ProgressBar> node = std::make_shared<ProgressBar>();
     ...
     */
    static std::shared_ptr<ProgressBar> alloc(const std::shared_ptr<graphics::Texture>& background, const Size size) {
        std::shared_ptr<ProgressBar> node = std::make_shared<ProgressBar>();
     ...
     * @return a newly allocated progress bar with the given textures and size.
     */
    static std::shared_ptr<ProgressBar> allocWithCaps(const std::shared_ptr<graphics::Texture>& background,
                                                      const std::shared_ptr<graphics::Texture>& foreground,
                                                      const std::shared_ptr<graphics::Texture>& beginCap,
                                                      const std::shared_ptr<graphics::Texture>& finalCap) {
        std::shared_ptr<ProgressBar> node = std::make_shared<ProgressBar>();
