...
//
#ifndef __CU_SCENE_NODE_2_H__
#define __CU_SCENE_NODE_2_H__
...
#pragma mark Identifiers
    ...
    /**
     * Returns the JSON data for this scene graph node, if it exists
     *
     * @return the JSON data for this scene graph node, if it exists
     */
...
#pragma mark Visibility
     ...
     * be the same as {@link graphics::Scissor#intersect}.
     *
     * @return the scissor associated with this node.
     */
    std::shared_ptr<graphics::Scissor> getScissor() const { return _scissor; }
     ...
     * be the same as {@link graphics::Scissor#intersect}.
     */
    void setScissor() { _scissor = graphics::Scissor::alloc(getContentSize());}
...
#pragma mark Scene Graph
     ...
     */
    void addChildWithName(const std::shared_ptr<SceneNode>& child, 
...
#pragma mark Internal Helpers
    ...
    // Tightly couple these two classes
    friend class Scene2;
};
    }
