...
//
//  In previous implementations, the x and y axis were locked to the orientation
//  device at the time of initialization. Now, we this to the control of the
//  programmer to ensure more uniform behavior.
//
...
//
//  Author: Walker White, Maheer Aeron
...
public:
    ...
    /**
     * Constructs a new acceleration event with the given values
     *
...
private:
    ...
    Display::Orientation _reference;
...
#pragma mark Calibration
    /**
     * Returns the frame of reference for the accelerometer.
     *
     * The reference frame enables a consistent accelerometer control when
     * your application changes between display orientations. An app in
     * landscape display mode and landscape reference frame will have the
     * same accelerometer controls as a portrait app with a portrait reference
     * frame. Currently, the only two supported frames of reference are
     * portrait or landscape.
     *
     * In portrait, the SDL index for the x and y axis are set to 0 and 1
     * respectively. In landscape, x and y axis are set to 1 and 0 instead.
     *
     * @return the frame of reference for the accelerometer.
     */
    Display::Orientation getReferenceFrame() const { return _reference; }
    
    /**
     * Sets the frame of reference for the accelerometer.
     *
     * The reference frame enables a consistent accelerometer control when
     * your application changes between display orientations. An app in
     * landscape display mode and landscape reference frame will have the
     ...
     * respectively. In landscape, x and y axis are set to 1 and 0 instead.
     *
     * @param orientation   The orientation for the frame of reference
     */
    void setReferenceFrame(Display::Orientation orientation);
