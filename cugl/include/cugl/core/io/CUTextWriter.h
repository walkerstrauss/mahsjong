...
#pragma mark Primitive Methods
     ...
     */
    void write(Uint8 b)                 { write(cugl::strtool::to_string(b)); }
     ...
     */
    void write(Sint16 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(Uint16 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(Sint32 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(Uint32 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(Sint64 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(Uint64 n)                { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(float n)                 { write(cugl::strtool::to_string(n)); }
     ...
     */
    void write(double n)                { write(cugl::strtool::to_string(n)); }
