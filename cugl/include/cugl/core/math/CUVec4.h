...
#pragma mark Setters
    ...
    Vec4& set(const Vec4 v) {
        std::memcpy(this, &v, 4*sizeof(float));
        return *this;
    }
     ...
     */
    Vec4& setZero() {
        std::memset(this,0,4*sizeof(float));
        return *this;
    }
...
#pragma mark Comparisons
     ...
     */
    bool equals(const Vec4 v, float epsilon=CU_MATH_EPSILON) const;
