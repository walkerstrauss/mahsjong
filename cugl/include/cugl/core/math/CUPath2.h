 ...
 *
 * It is possible to draw a path object directly to a {@link graphics::SpriteBatch}.
 * However, in most applications you will want to convert a path object to a
 * {@link Poly2} for width and texturing. In particular, you will often want to
