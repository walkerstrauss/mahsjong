...
#pragma mark Loading Interface
     ...
     *
     * This method safely loads the portion of the asset that can be loaded
     * outside of the main CUGL thread. That means, if the asset needs access
     * to OpenGL or the audio engine as part of its loading, that should not
