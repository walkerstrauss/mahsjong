...
//  Widgets. It is effectively equivalent to JsonLoader, as JsonValues and
//  WidgetValues are only separated for the purposes of typing
//
...
#include <cugl/core/assets/CUJsonLoader.h>
...
/**
 * This class is a implementation of Loader<WidgetValue>
 *
 * This asset loader allows us to allocate widgets. As widgets are just JSONs
 * in a special format, this is essentially identical to {@link JsonLoader}.
 * It is separated for the purposes of typing.
 *
 * As with all of our loaders, this loader is designed to be attached to an
...
protected:
     ...
     *
     * Allocating a widget value can be done safely in a separate thread.
     ...
     */
    bool materialize(const std::string key, const std::shared_ptr<WidgetValue>& widget,
     ...
     *
     * Widget loading is always asynchronously safe, so this method does not
...
#pragma mark Constructors
    ...
    /**
     * Returns a newly allocated widget loader.
     *
