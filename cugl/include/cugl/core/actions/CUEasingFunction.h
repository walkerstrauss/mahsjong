 ...
 * an action. If f(t) = t, the result is standard linear interpolation,
 * providing a smooth animation. Nonlinear curves allow the animation to
 * adjust its speed over time. An easing function can map outside of the range
 * so long as the end points are still fixed. This allows for overshoot and
 * correction in the animation. See
 *
 *     http://easings.net
 *
 ...
 * can be used by other functions for animation support.
 */
class EasingFactory {
public:
    /**
     ...
     */
    static EasingFunction alloc(Type type, float period = ELASTIC_PERIOD);
    
    /**
     * Returns an adjustment of the interpolation value
     *
     * This is a linear easing function (the default)
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     */
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a sine function with an asymptotic start at t=0.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #sineIn(float)} and
     * {@link #sineOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #quadIn(float)} and
     * {@link #quadOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #cubicIn(float)} and
     * {@link #cubicOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #quartIn(float)} and
     * {@link #quartOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #quintIn(float)} and
     * {@link #quintOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link expoIn(float)} and 
     * {@link expoOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #circIn(float)} and
     * {@link #circOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the interpolation value
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is a concatenation of the {@link #backIn(float)} and
     * {@link #backOut(float)} easing functions.
     *
     * @param time  The time in seconds.
     *
     * @return An adjustment of the tweening time
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is an easing function that bounces down to t=0 several times after 
     * the start.
     *
     * @param time  The time in seconds.
     *
     ...
     * Returns an adjustment of the interpolation value
     *
     * This is an easing function that bounces up to t=1 several times before 
     * the finish.
     *
     * @param time  The time in seconds.
     *
...
#endif /* __CU_EASING_FUNCTION_H__ */
