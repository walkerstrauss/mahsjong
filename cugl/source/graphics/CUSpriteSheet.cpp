...
//
#include <cugl/graphics/CUSpriteSheet.h>
 ...
 */
bool SpriteSheet::init(const std::shared_ptr<Texture>& texture, 
 ...
 */
void SpriteSheet::draw(const std::shared_ptr<SpriteBatch>& batch,
