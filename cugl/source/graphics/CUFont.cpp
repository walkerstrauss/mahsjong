 ...
 */
bool Font::Atlas::getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh, const Rect rect) const {
 ...
 * @param mesh      The mesh to store the vertices
 */
void Font::Atlas::getQuad(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh) const {
    CUAssertLog(mesh.command == GL_TRIANGLES, "The mesh is not formatted for triangles");
 ...
 */
Mesh<SpriteVertex> Font::getGlyphBoxes(const std::string text, const Vec2 origin) {
    const char* begin = text.c_str();
    const char* end = begin+text.size();
    Rect bounds(origin,getSize(begin,end));
 ...
 * @return a (line) mesh of the quad outlines for the text glyphs
 */
Mesh<SpriteVertex> Font::getGlyphBoxes(const char* substr, const char* end, const Vec2 origin) {
    Rect bounds(origin,getSize(substr,end));
 ...
 * @return a (line) mesh of the quad outlines for the text glyphs
 */
Mesh<SpriteVertex> Font::getGlyphBoxes(const char* substr, const char* end,
                                       const Vec2 origin, const Rect rect, float track) {
 ...
 */
size_t Font::getGlyphBoxes(Mesh<SpriteVertex>& mesh, const std::string text, const Vec2 origin) {
    const char* begin = text.c_str();
    const char* end = begin+text.size();
    Rect bounds(origin,getSize(begin,end));
 ...
 * @return the number of quads generated
 */
size_t Font::getGlyphBoxes(Mesh<SpriteVertex>& mesh, const char* substr, const char* end, const Vec2 origin) {
    Rect bounds(origin,getSize(substr,end));
 ...
 * @return the number of quads generated
 */
size_t Font::getGlyphBoxes(Mesh<SpriteVertex>& mesh, const std::string text,
                           const Vec2 origin, const Rect rect, float track) {
    const char* begin = text.c_str();
    const char* end = begin+text.size();
 ...
 * @return the number of quads generated
 */
size_t Font::getGlyphBoxes(Mesh<SpriteVertex>& mesh, const char* substr, const char* end,
                           const Vec2 origin, const Rect rect, float track) {
    Rect bounds = rect;
    bounds.origin.x -= _atlasPadding;
    bounds.origin.y -= _atlasPadding;
 ...
 * @param mesh      The mesh to store the vertices
 */
bool Font::getOutline(Uint32 thechar, Vec2& offset, Mesh<SpriteVertex>& mesh, const Rect rect) {
