 ...
 * @return true if initialization was successful.
 */
bool SceneNode::initWithData(const AssetManager* manager,
    ...
    if (data->has("color")) {
        _tintColor.set(json_color(data->get("color").get(), "#ffffff"));
    }
 ...
 */
bool SceneNode::inContentBounds(const Vec2 point) {
