 ...
 *
 * @param name  The string representation of the color
 */
 ...
 * @return the packed integer representation of this color
 */
Uint32 Color4f::getPacked() const {
 ...
 */
Color4& Color4::set(Uint32 color) {
    rgba = marshall(color);
    return *this;
}
 ...
 * @return A reference to this (modified) Color4f for chaining.
 */
Color4& Color4::setHSV(float h, float s, float v, Uint8 a) {
    float l = v*(1-s/2);
    float s0 = l == 0 || l == 1 ? 0 : (v-l)/std::min(l,1-l);
    return setHSL(h,s0,l,a);
}
 ...
 * @return A reference to this (modified) Color4f for chaining.
 */
Color4& Color4::setHSL(float h, float s, float l, Uint8 a) {
    this->a = a;
...
Color4& Color4::blend(Color4 other) {
    ...
    float a2 = srca+a1;
    r = clampb((Uint8)((other.r*srca+r*a1)/a2),0,255);
    g = clampb((Uint8)((other.g*srca+g*a1)/a2),0,255);
    b = clampb((Uint8)((other.b*srca+b*a1)/a2),0,255);
...
Color4* Color4::blend(Color4 c1, Color4 c2, Color4* dst) {
    ...
    float a2 = srca+a1;
    dst->r = clampb((Uint8)((c1.r*srca+c2.r*a1)/a2),0,255);
    dst->g = clampb((Uint8)((c1.g*srca+c2.g*a1)/a2),0,255);
    dst->b = clampb((Uint8)((c1.b*srca+c2.b*a1)/a2),0,255);
...
Color4& Color4::blendPre(Color4 other) {
    ...
    r = clampb((Uint8)(other.r+r*(1-srca)),0,255);
    g = clampb((Uint8)(other.g+g*(1-srca)),0,255);
    b = clampb((Uint8)(other.b+b*(1-srca)),0,255);
...
Color4* Color4::blendPre(Color4 c1, Color4 c2, Color4* dst) {
    ...
    dst->r = clampb((Uint8)(c1.r+c2.r*(1-srca)),0,255);
    dst->g = clampb((Uint8)(c1.g+c2.g*(1-srca)),0,255);
    dst->b = clampb((Uint8)(c1.b+c2.b*(1-srca)),0,255);
...
Color4 Color4::getBlend(Color4 other) const {
  ...
  float a1 = COLOR_BYTE_TO_FLOAT(a)*(1-srca);
  float a2 = srca+a1;
  return Color4(clampb((Uint8)((other.r*srca+r*a1)/a2), 0, 255),
                clampb((Uint8)((other.g*srca+g*a1)/a2), 0, 255),
                clampb((Uint8)((other.b*srca+b*a1)/a2), 0, 255),
...
Color4 Color4::getBlendPre(Color4 other) const {
  ...
  return Color4(clampb((Uint8)(other.r+r*(1-srca)),0,255),
                clampb((Uint8)(other.g+g*(1-srca)),0,255),
                clampb((Uint8)(other.b+b*(1-srca)),0,255),
