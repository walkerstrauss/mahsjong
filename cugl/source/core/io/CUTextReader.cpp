 ...
 */
bool TextReader::init(const std::string file) {
 ...
 * @return true if the reader is initialized properly, false otherwise.
 */
bool TextReader::init(const std::string file, unsigned int capacity) {
 ...
 * @return true if the reader is initialized properly, false otherwise.
 */
bool TextReader::initWithAsset(const std::string file) {
 ...
 * @return true if the reader is initialized properly, false otherwise.
 */
bool TextReader::initWithAsset(const std::string file, unsigned int capacity) {
    CUAssertLog(capacity, "The buffer capacity must be positive");
