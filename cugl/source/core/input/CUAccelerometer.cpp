...
bool Accelerometer::init() {
    ...
    _reference = Display::get()->getInitialOrientation();
    switch (_reference) {
...
bool Accelerometer::updateState(const SDL_Event& event, const Timestamp& stamp) {
    ...
    _current.set(SDL_JoystickGetAxis(_input, _xaxis),
                 SDL_JoystickGetAxis(_input, _yaxis),
                 SDL_JoystickGetAxis(_input, 2));
    ...
    // Only register events above threshold
 ...
 */
void Accelerometer::setReferenceFrame(Display::Orientation orientation) {
    switch (orientation) {
        case Display::Orientation::LANDSCAPE:
        case Display::Orientation::LANDSCAPE_REVERSED:
            _xaxis = 1; _yaxis = 0;
        ...
        case Display::Orientation::UPSIDE_DOWN:
            ...
            break;
        default:
            CUAssertLog(false, "Unsupported orientation");
    }
