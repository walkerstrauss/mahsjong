...
//  EasingFactory without having to explicitly define a function.
//
...
#include <cugl/core/actions/CUEasingBezier.h>
 ...
 */
bool EasingBezier::init(EasingFactory::Type type) {
    switch(type) {
    case EasingFactory::Type::LINEAR:
        return init(0.25f,0.25f,0.75f,0.75f);
    case EasingFactory::Type::SINE_IN:
        return init(0.47f, 0, 0.745f, 0.715f);
    case EasingFactory::Type::SINE_OUT:
        return init(0.39f, 0.575f, 0.565f, 1);
    case EasingFactory::Type::SINE_IN_OUT:
        return init(0.445f, 0.05f, 0.55f, 0.95f);
    case EasingFactory::Type::QUAD_IN:
        return init(0.55f, 0.085f, 0.68f, 0.53f);
    case EasingFactory::Type::QUAD_OUT:
        return init(0.25f, 0.46f, 0.45f, 0.94f);
    case EasingFactory::Type::QUAD_IN_OUT:
        return init(0.455f, 0.03f, 0.515f, 0.955f);
    case EasingFactory::Type::CUBIC_IN:
        return init(0.55f, 0.055f, 0.675f, 0.19f);
    case EasingFactory::Type::CUBIC_OUT:
        return init(0.215f, 0.61f, 0.355f, 1);
    case EasingFactory::Type::CUBIC_IN_OUT:
        return init(0.645f, 0.045f, 0.355f, 1);
    case EasingFactory::Type::QUART_IN:
        return init(0.95f, 0.05f, 0.795f, 0.035f);
    case EasingFactory::Type::QUART_OUT:
        return init(0.165f, 0.84f, 0.44f, 1);
    case EasingFactory::Type::QUART_IN_OUT:
        return init(0.77f, 0, 0.175f, 1);
    case EasingFactory::Type::QUINT_IN:
        return init(0.755f, 0.05f, 0.855f, 0.06f);
    case EasingFactory::Type::QUINT_OUT:
        return init(0.23f, 1, 0.32f, 1);
    case EasingFactory::Type::QUINT_IN_OUT:
        return init(0.86f, 0, 0.07f, 1);
    case EasingFactory::Type::EXPO_IN:
        return init(0.95f, 0.05f, 0.795f, 0.035f);
    case EasingFactory::Type::EXPO_OUT:
        return init(0.19f, 1, 0.22f, 1);
    case EasingFactory::Type::EXPO_IN_OUT:
        return init(1, 0, 0, 1);
    case EasingFactory::Type::CIRC_IN:
        return init(0.6f, 0.04f, 0.98f, 0.335f);
    case EasingFactory::Type::CIRC_OUT:
        return init(0.075f, 0.82f, 0.165f, 1);
    case EasingFactory::Type::CIRC_IN_OUT:
        return init(0.785f, 0.135f, 0.15f, 0.86f);
    case EasingFactory::Type::BACK_IN:
        return init(0.6f, -0.28f, 0.735f, 0.045f);
    case EasingFactory::Type::BACK_OUT:
        return init(0.175f, 0.885f, 0.32f, 1.275f);
    case EasingFactory::Type::BACK_IN_OUT:
