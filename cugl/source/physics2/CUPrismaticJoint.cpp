...
#include <cugl/physics2/CUPrismaticJoint.h>
 ...
 */
bool PrismaticJoint::initWithObstacles(const std::shared_ptr<Obstacle>& obsA,
 ...
 */
bool PrismaticJoint::activatePhysics(b2World& world) {
    ...
    def.lowerTranslation = _lowerTranslation;
    def.upperTranslation = _upperTranslation;
    ...
    def.localAxisA.Set(_localAxisA.x, _localAxisA.y);
