...
#include <cugl/physics2/CUWheelJoint.h>
...
*/
bool WheelJoint::initWithObstacles(const std::shared_ptr<Obstacle>& obsA,
 ...
 */
bool WheelJoint::activatePhysics(b2World& world) {
