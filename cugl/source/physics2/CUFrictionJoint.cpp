...
#include <cugl/physics2/CUFrictionJoint.h>
 ...
 */
bool FrictionJoint::initWithObstacles(const std::shared_ptr<Obstacle>& obsA,
 ...
 */
bool FrictionJoint::activatePhysics(b2World& world) {
