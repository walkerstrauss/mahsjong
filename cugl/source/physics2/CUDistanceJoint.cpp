...
#include <cugl/physics2/CUDistanceJoint.h>
 ...
 */
DistanceJoint::DistanceJoint() : Joint(),
_length(1.0f),
_minLength(0.0f),
_maxLength(FLT_MAX),
_stiffness(0.0f),
_damping(0.0f) {
    _type = e_distanceJoint;
}
 ...
 */
bool DistanceJoint::initWithObstacles(const std::shared_ptr<Obstacle>& obsA,
 ...
 */
bool DistanceJoint::activatePhysics(b2World& world) {
