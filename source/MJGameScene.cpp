...
//            addCelestialAnim("ox");
            AnimationController::getInstance().addSpriteSheetAnimation(_oxSheet, 0, 6, true, 1, 3, false);
            break;
        case MatchController::SNAKE:
//            addCelestialAnim("snake");
            AnimationController::getInstance().addSpriteSheetAnimation(_snakeSheet, 0, 17, true, 1, 3, false);
            break;
        case MatchController::RABBIT:
//            addCelestialAnim("rabbit");
            AnimationController::getInstance().addSpriteSheetAnimation(_rabbitSheet, 0, 6, true, 1, 3, false);
            break;
        case MatchController::RAT:
//            addCelestialAnim("rat");
            AnimationController::getInstance().addSpriteSheetAnimation(_ratSheet, 0, 12, true, 1, 3, false);
            break;
        case MatchController::MONKEY:
//            addCelestialAnim("monkey");
            AnimationController::getInstance().addSpriteSheetAnimation(_monkeySheet, 0, 8, true, 1, 3, false);

            break;
        case MatchController::DRAGON:
//            addCelestialAnim("dragon");
            AnimationController::getInstance().addSpriteSheetAnimation(_dragonSheet, 0, 15, true, 1, 3, false);
            break;
        case MatchController::ROOSTER:
//            addCelestialAnim("rooster");
            AnimationController::getInstance().addSpriteSheetAnimation(_roosterSheet, 0, 11, true,1, 3, false);
            break;
        case MatchController::PIG:
//            addCelestialAnim("pig");
            AnimationController::getInstance().addSpriteSheetAnimation(_pigSheet, 0, 13, true, 1, 3, false);
            break;
        default:
            break;
    }
